...
CREATE TABLE books (
				...
				PRIMARY KEY (book_type, author_id, publisher_id),
...
VALUES (1, 'Mor Salkımlı Ev', 1, 2, 1, 40)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (2, 'Vurun Kahpeye', 1, 2, 4, 32)  -- 1 -> 4 yapıldı
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (3, 'Vurun Kahpeye', 1, 2, 2, 12)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (4, 'Şehir Mektupları', 2, 3, 4, 65)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (5, 'Çile', 4, 4, 5, 100.00)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (6, 'Çöle İnen Nur', 3, 4, 5, 120)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (7, 'Dördüncü Bölük', 3, 5, 7, 21)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (8, 'Sonuncu İz', 3, 8, 1, 29)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (9, 'Animal Farm', 3, 6, 8, 55)
INSERT INTO books (book_id , book_name, book_type, author_id, publisher_id, price) 
VALUES (10, 'Love Byte', 3, 7, 9, 35)